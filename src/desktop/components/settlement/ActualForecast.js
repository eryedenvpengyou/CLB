...
class ActualForecast extends React.Component{
    ...
    componentDidMount(){
        ...
        service.queryPaymentForecast(settlementParams).then((data)=>{
                    ...
                    <div>
                        <Form layout='inline' style={{margin:'20px 0'}}>
                            <Form.Item>
                                <Button 
                                type='primary' 
                                style={{fontSize:'20px',width:'140px',height:'40px',marginRight:'180px'}}
                                onClick={()=>location.hash='/settlement/paymentNew/000'}
                                >新建对账单</Button>
                            </Form.Item> 
                            <Form.Item>
                                {
...
export default Form.create()(ActualForecast)