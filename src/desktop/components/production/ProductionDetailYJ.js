...
class ProductionDetailComponent extends React.Component {
  ...
  subscribe() {
    location.hash = '/production/subscribe/YJ/'+(this.state.productDetail.midClass||"YJ")+'/'+this.state.productDetail.itemId;
  }
  //计算文件大小
            ...
            <Col style={{float:'left',marginLeft:'32px',width:'510px'}}>
              ...
              <Row style={{marginTop:'50px',fontSize:'16px'}}>
                价格：
                {
                  ...
                  this.state.productDetail.prdItemSublineList.length == 1?
                  this.state.productDetail.prdItemSublineList[0]:
                    this.numberFlag ?
