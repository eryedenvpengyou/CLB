          ...
          <div>
            <Form onSubmit={this.handleSearch}>
              <Row style={{marginBottom : '20px'}}>
                ...
                <Col span={3}>
                  <Button type='primary' style={{fontSize:'20px',width : '140px',height:'40px',backgroundColor:JSON.parse(localStorage.theme).themeColor,color:'white'}}  onClick={()=>location.hash ='/after/AfterNew/0/0/'+0}>售后申请</Button>
                </Col>
              </Row>
              <Row>
