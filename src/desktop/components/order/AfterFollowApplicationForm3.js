...
class AfterApplicationForm3 extends React.Component {
            ...
            if(params.content){
              service.submitAfterFollow(params).then((data) => {
                if(data.success){
                  ...
                  Modals.success({
                    content:'提交成功',
                    url:'/after/AfterFollowApplication/'+this.props.afterId+'/'+this.props.orderId+'/'+'TOAUDIT'
...
AfterApplicationForm3 = Form.create()(AfterApplicationForm3);

export default AfterApplicationForm3;
